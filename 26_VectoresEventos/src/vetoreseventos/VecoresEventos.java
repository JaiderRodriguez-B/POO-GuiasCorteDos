 ...
 * @author Asus
 */
public class VecoresEventos extends javax.swing.JFrame {

    JButton vBotones[];

    /**
     * Creates new form VecoresEventos
     */
    public VecoresEventos() {
        initComponents();
        CreacionVentana();
    }
    ...
    public void CreacionVentana() {
        ...
        String textoBotones[] = {"Acepar", "Cancelar", "Aplicar", "Cerrar", "Salir"};
        ...
        for (i = 0; i < vBotones.length; i++) {
            ...
            vBotones[i].setBounds(10 + i * 100, 100, 90, 25);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VecoresEventos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VecoresEventos().setVisible(true);
            }
        });
    }
