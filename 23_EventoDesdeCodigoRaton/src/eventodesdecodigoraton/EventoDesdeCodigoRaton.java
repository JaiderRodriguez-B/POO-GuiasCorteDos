 ...
 */
package eventodesdecodigoraton;
 ...
 * @author Asus
 */
public class EventoDesdeCodigoRaton extends javax.swing.JFrame {

    JLabel etiTexto;
    JLabel etiZona;

    /**
     * Creates new form EventoDesdeCodigoRaton
     */
    public EventoDesdeCodigoRaton() {
        initComponents();
        CreacionVentana();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EventoDesdeCodigoRaton.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EventoDesdeCodigoRaton().setVisible(true);
            }
        });
    }
