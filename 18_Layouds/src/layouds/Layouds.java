 ...
 * @author conta
 */
public class Layouds extends javax.swing.JFrame {

    /**
     * Creates new form Layouds
     */
    public Layouds() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Layouds.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
